...
class StoryCell: UITableViewCell {
    ...
    var pinkImageView = UIImageView()
    var plusImageView = UIImageView()
    var anotherImageView = UIImageView()
    var anotherImageView2 = UIImageView()
    var anotherImageView3 = UIImageView()
    var anotherImageView4 = UIImageView()
    var anotherImageView5 = UIImageView()
    var myLabel = UILabel()
    var label2 = UILabel()
    var label3 = UILabel()
    var label4 = UILabel()
    ...
    func setupUI() {
        ...
        myLabel.text = "Ваша история"
        myLabel.font = UIFont(name: "Verdana", size: 8)
        label2.text = "lavanda123"
        label2.font = UIFont(name: "Verdana", size: 8)
        label3.text = "lavanda123"
        label3.font = UIFont(name: "Verdana", size: 8)
        label4.text = "lavanda123"
        label4.font = UIFont(name: "Verdana", size: 8)
        label5.text = "lavanda123"
        label5.font = UIFont(name: "Verdana", size: 8)
        label6.text = "lavanda123"
        label6.font = UIFont(name: "Verdana", size: 8)
