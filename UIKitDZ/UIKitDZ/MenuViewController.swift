...
final class MenuViewController: UIViewController {
    ...
    private let logoImageView = {
        let imageView = UIImageView(image: UIImage(named: AuthorizationViewController.Constants.cafeName))
    ...
    private let greetingLabel = {
        ...
        label.text = AuthorizationViewController.Constants.welcome
    ...
    private let nameLabel = {
        ...
        label.text = AuthorizationViewController.Constants.gLetter
    ...
    private let adressesLabel = {
        ...
        label.text = AuthorizationViewController.Constants.adresses
        label.font = UIFont(name: AuthorizationViewController.Constants.verdana, size: 12)
    ...
    private let allowAccessLabel = {
        ...
        label.text = AuthorizationViewController.Constants.accessToGeo
        label.font = UIFont(name: AuthorizationViewController.Constants.verdana, size: 12)
        label.numberOfLines = 0
    ...
    private let geoButton = {
        ...
        button.setImage(UIImage(named: AuthorizationViewController.Constants.geo), for: .normal)
        return button
    }()

    private let menuImageView = {
        let imageView = UIImageView(image: UIImage(named: AuthorizationViewController.Constants.menu))
    ...
    private let cakeImageView = {
        let imageView = UIImageView(image: UIImage(named: AuthorizationViewController.Constants.cake))
    ...
    private let cakeLabel = {
        ...
        label.text = AuthorizationViewController.Constants.ptiPatealaRus
        label.font = UIFont(name: AuthorizationViewController.Constants.verdana, size: 16)
    ...
    private let teaImageView = {
        let imageView = UIImageView(image: UIImage(named: AuthorizationViewController.Constants.tea))
    ...
    private let teaLabel = {
        ...
        label.text = AuthorizationViewController.Constants.hotDrinks
        label.font = UIFont(name: AuthorizationViewController.Constants.verdana, size: 16)
        label.font = UIFont(descriptor: fontDescriptor, size: 0)
        return label
    }()
    ...
    private let coffeeImageView = {
        let imageView = UIImageView(image: UIImage(named: AuthorizationViewController.Constants.coffee))
    ...
    private let coffeeLabel = {
        ...
        label.text = AuthorizationViewController.Constants.kofiy
        label.font = UIFont(name: AuthorizationViewController.Constants.verdana, size: 16)
        label.font = UIFont(descriptor: fontDescriptor, size: 0)
        return label
    }()
